...
PROBE_GROUPS: dict[str, tuple[ProbeCase, ...]] = {
    ...
    "malformed-number-unit": (
        ...
        ProbeCase("malformed-beon", "+3번", "+3번"),
        ProbeCase("malformed-jeom", "-3점", "-3점"),
        ProbeCase("malformed-jo", "1,00조", "1,00조"),
        ProbeCase("malformed-bu", "01부", "01부"),
        ProbeCase("malformed-dong", "+3동", "+3동"),
        ProbeCase("malformed-ho", "-3호", "-3호"),
        ProbeCase("malformed-pan", "1.5판", "1.5판"),
        ProbeCase("malformed-dan", "1,00단", "1,00단"),
        ProbeCase("malformed-deung", "3A등", "3A등"),
        ProbeCase("malformed-cheok", "01척", "01척"),
        ProbeCase("malformed-jang", "+3장", "+3장"),
        ProbeCase("malformed-gwon", "-3권", "-3권"),
        ProbeCase("malformed-pyeon", "1.5편", "1.5편"),
