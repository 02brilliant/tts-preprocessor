...
CASES = [
    ...
    ProbeCase("strong_0_05", "0:05", "영시 오분"),
    ProbeCase("strong_01_40", "01:40", "한시 사십분"),
    ProbeCase("strong_02_30", "02:30", "두시 삼십분"),
    ProbeCase("strong_08_30", "08:30", "여덟시 삼십분"),
    ProbeCase("strong_09_30", "09:30", "아홉시 삼십분"),
    ProbeCase("strong_10_00", "10:00", "열시"),
    ProbeCase("strong_11_05", "11:05", "열한시 오분"),
    ProbeCase("strong_12_00", "12:00", "열두시"),
    ...
    ProbeCase(
        "suffix_leading_zero_minute_second",
        "23분045초",
        "이십삼분 사십오초",
    ),
    ProbeCase(
        "suffix_large_minute_second",
        "123분545초",
        "백이십삼분 오백사십오초",
    ),
    ProbeCase(
    ...
    ProbeCase("ambiguous_10_30_preserve", "10:30", "10:30"),
    ProbeCase("ambiguous_12_59_preserve", "12:59", "12:59"),
    ProbeCase("ambiguous_23_59_preserve", "23:59", "23:59"),
    ...
    ProbeCase("ambiguous_10_30_postposition", "10:30에", "열시 삼십분에"),
    ProbeCase("ambiguous_12_59_postposition", "12:59에", "열두시 오십구분에"),
    ProbeCase(
        "ambiguous_23_59_postposition",
        "23:59에",
        "이십삼시 오십구분에",
    ),
