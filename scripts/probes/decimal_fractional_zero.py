...
CASES = [
    ...
    ProbeCase("unit_khz_decimal", "2.35kHz", "이쩜삼오 킬로헤르츠"),
    ProbeCase("unit_kb_decimal", "2.35KB", "이쩜삼오 킬로바이트"),
    ProbeCase("unit_plain_five_digit_decimal", "10000.5kg", "만쩜오 킬로그램"),
    ProbeCase("exact_compound_decimal", "2.35Mbps", "이쩜삼오 메가비피에스"),
    ProbeCase("decimal_counter_tail", "2.35명쯤", "이쩜삼오 명쯤"),
    ProbeCase(
    ...
    ProbeCase("ph_sentence_dot", "pH 7.4.", "피에이치 칠쩜사."),
    ProbeCase(
    ...
    ProbeCase("caret_exact_power", "2.35m^2", "이쩜삼오 제곱미터"),
    ProbeCase("caret_literal_power", "2.35KB^2", "이쩜삼오KB^2"),
