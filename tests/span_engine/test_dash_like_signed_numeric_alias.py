...
@pytest.mark.parametrize(
    ("text", "expected"),
    [
        ('-0.11%', '마이너스 영-쩜-일일-퍼센트'),
        ('–2.03%', '마이너스 이-쩜-영삼-퍼센트'),
        ('국내채권 –2.03%', '국내채권 마이너스 이-쩜-영삼-퍼센트'),
        ('이 가운데 국내 주식 수익률은 21.67%, 해외 주식 -0.11%, 국내채권 –2.03%, 해외 채권 4.98% 등입니다.', '이 가운데 국내 주식 수익률은 이십일-쩜-육칠-퍼센트, 해외 주식 마이너스 영-쩜-일일-퍼센트, 국내채권 마이너스 이-쩜-영삼-퍼센트, 해외 채권 사-쩜-구팔-퍼센트 등입니다.'),
        ('−2.03%', '마이너스 이-쩜-영삼-퍼센트'),
        ('－2.03%', '마이너스 이-쩜-영삼-퍼센트'),
        ('—2.03%', '마이너스 이-쩜-영삼-퍼센트'),
        ('‒2.03%', '마이너스 이-쩜-영삼-퍼센트'),
        ('‑2.03%', '마이너스 이-쩜-영삼-퍼센트'),
        ('–2.03', '마이너스 이-쩜-영삼'),
        ('–2.03kg', '마이너스 이-쩜-영삼-킬로그램'),
        ('–2.03℃', '영하 이-쩜-영삼도'),
        ('–2.5%p', '마이너스 이-쩜-오-퍼센트포인트'),
    ],
)
...
def test_dash_like_signed_percent_full_claims_source_span() -> None:
    ...
    assert output.normalized_text == "마이너스 이-쩜-영삼-퍼센트"
    ...
    assert [(piece.text, piece.provenance) for piece in output.render_pieces] == [
        ("마이너스 이-쩜-영삼-퍼센트", "GENERATED_READING")
    ]
