...
@pytest.mark.parametrize(
    ("src", "expected"),
    [
        ('환자 수는 천명당 4.3명으로 집계됐습니다.', '환자 수는 천명당 사-쩜-삼-명으로 집계됐습니다.'),
        ('이전 수치는 1.3명에서 5.9명으로 늘었습니다.', '이전 수치는 일-쩜-삼-명에서 오-쩜-구-명으로 늘었습니다.'),
        ('평점 3.5점의 작품을 비교했습니다.', '평점 삼-쩜-오-점의 작품을 비교했습니다.'),
        ('장비는 평균 2.5개였고 차량은 가구당 1.5대였습니다.', '장비는 평균 이-쩜-오-개였고 차량은 가구당 일-쩜-오-대였습니다.'),
        ('책은 평균 3.2권이었고 표본은 4.7장으로 기록됐습니다.', '책은 평균 삼-쩜-이-권이었고 표본은 사-쩜-칠-장으로 기록됐습니다.'),
        ('동물은 구역당 2.5마리로 조사됐습니다.', '동물은 구역당 이-쩜-오-마리로 조사됐습니다.'),
        ('조사는 6.5건이었고 회의는 7.5회였습니다.', '조사는 육-쩜-오-건이었고 회의는 칠-쩜-오-회였습니다.'),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('작업은 2.5시간 걸렸습니다.', '작업은 이-쩜-오-시간 걸렸습니다.'),
        ('기간은 3.5일입니다.', '기간은 삼-쩜-오-일입니다.'),
        ('관찰 기간은 4.5주였습니다.', '관찰 기간은 사-쩜-오-주였습니다.'),
        ('평균 기간은 5.5개월입니다.', '평균 기간은 오-쩜-오-개월입니다.'),
        ('평균 보유 기간은 6.5년입니다.', '평균 보유 기간은 육-쩜-오-년입니다.'),
    ],
)
...
@pytest.mark.parametrize(
    ("src", "expected"),
    [
        ('길이는 1.5m입니다.', '길이는 일-쩜-오-미터입니다.'),
        ('무게는 2.3kg입니다.', '무게는 이-쩜-삼-킬로그램입니다.'),
        ('습도는 42.8%였습니다.', '습도는 사십이-쩜-팔-퍼센트였습니다.'),
        ('지표는 3.5%P 하락했습니다.', '지표는 삼-쩜-오-퍼센트포인트 하락했습니다.'),
        ('가격은 1,000.5원 올랐습니다.', '가격은 천-쩜-오-원 올랐습니다.'),
        ('주가는 4.8배 증가했습니다.', '주가는 사-쩜-팔-배 증가했습니다.'),
        ('점수는 2.1대1.5였습니다.', '점수는 이-쩜-일 대 일-쩜-오였습니다.'),
        ('범위는 1.5~2.5명입니다.', '범위는 일-쩜-오에서 이-쩜-오-명입니다.'),
    ],
)
...
@pytest.mark.parametrize(
    ("src", "expected"),
    [
        ('평균은 1.5차였습니다.', '평균은 일-쩜-오-차였습니다.'),
        ('점수는 1.5과였습니다.', '점수는 일-쩜-오-과였습니다.'),
        ('경계는 1.5선입니다.', '경계는 일-쩜-오-선입니다.'),
    ],
)
