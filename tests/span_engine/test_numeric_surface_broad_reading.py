...
INTEGRATED_EXPECTED = (
    "오늘 실험실 온도는 영상 이십오도였고, 아침에는 영하 삼도였지만, 문장 끝에는 플러스 일-쩜-오-킬로그램. "
    "문장 끝에는 영상 삼-쩜-일사영도. 문장 끝 숫자 삼-쩜-일사영. 문장끝 숫자 오. "
    "단독 플러스 일 대 이와 삼 대 사는 문맥이 없어도, 시간이 아니면 읽어야 한다. "
    "입력값 플러스 일-쩜-오에서 이 구간과 삼-쩜-사일영에서 삼-쩜-오육 범위, 음수 입력인 마이너스 이-쩜-사팔영에서 삼-쩜-이사까지 읽어야 한다. "
    "마이너스 이-쩜-사팔영에서 삼-쩜-이사 이건 못읽는데, 마이너스 이-쩜-사팔영에서 플러스 삼-쩜-이사 이건 읽는다."
)
