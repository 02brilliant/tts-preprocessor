...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("5분이 남았다", "분", "deferred", "time_or_person"),
        ("3번 버스", "번", "confirmed", "identifier"),
        ("3번 확인했다", "번", "deferred", "occurrence_or_identifier"),
        ("작품 3점을 전시했다", "점", "confirmed", "item_count"),
        ("3점이 공개됐다", "점", "deferred", "score_or_item"),
        ("학생을 3조로 나눴다", "조", "confirmed", "group_count"),
        ("3조가 발표했다", "조", "deferred", "large_number_or_group"),
    ],
)
