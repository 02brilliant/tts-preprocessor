...
@pytest.mark.parametrize(
    ("source", "expected"),
    [
        ('12,345,678,901', '백이십삼억 사천-오백육십칠만 팔천-구백일'),
        (
            "12,345,678,901,234",
            "십이조 삼천-사백오십육억 칠천-팔백구십만 천이백삼십사",
        ),
        (
            "12,345,678,901,234,567",
            "일경 이천삼백-사십오조 육천-칠백팔십구억 백이십삼만 사천-오백육십칠",
        ),
        ("12,345", "만 이천삼백사십오"),
        ('123,456', '십이만 삼천-사백오십육'),
        ('1,234,567', '백이십삼만 사천-오백육십칠'),
        ("10,000", "만"),
        ("100,000,000", "일억"),
        ("1,000,000,000", "십억"),
...
@pytest.mark.parametrize(
    ...
    [
        ("101명", "백일-명"),
        ("12,345명", "만 이천삼백사십오-명"),
        ('123,456명', '십이만 삼천-사백오십육-명'),
        (
            "12,345,678,901,234명",
            "십이조 삼천-사백오십육억 칠천-팔백구십만 천이백삼십사-명",
        ),
        ("12,345원", "만 이천삼백사십오-원"),
