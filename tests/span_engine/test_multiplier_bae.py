...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('수익률은 1.5배 올랐다.', '수익률은 일-쩜-오-배 올랐다.'),
        ('수익률은 0.5배 올랐다.', '수익률은 영-쩜-오-배 올랐다.'),
        ('거래액은 2.25배로 늘었다.', '거래액은 이-쩜-이오-배로 늘었다.'),
        ("규모는 1,000배 확대됐다.", "규모는 천-배 확대됐다."),
        ('거래액은 1,000.5배 확대됐다.', '거래액은 천-쩜-오-배 확대됐다.'),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('수익이 1.5배였다.', '수익이 일-쩜-오-배였다.'),
        ('수익이 1.5 배였다.', '수익이 일-쩜-오-배였다.'),
    ],
)
