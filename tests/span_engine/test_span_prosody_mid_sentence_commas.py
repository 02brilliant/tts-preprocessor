...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('값은 1,000.5원입니다 하지만 변동폭은 2.5%P입니다.', '값은 천-쩜-오-원입니다, 하지만 변동폭은 이-쩜-오-퍼센트포인트입니다.'),
        ('점수는 2대1입니다 하지만 2.1대 1.5는 아닙니다.', '점수는 이대일입니다, 하지만 이-쩜-일 대 일-쩜-오는 아닙니다.'),
        ('비율은 1/3대 2/5입니다 반면 값은 3.14입니다.', '비율은 삼분의 일 대 오분의 이입니다, 반면 값은 삼-쩜-일사입니다.'),
    ],
)
