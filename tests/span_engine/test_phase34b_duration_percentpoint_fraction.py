...
@pytest.mark.parametrize(
    ("text", "expected"),
    [
        ('경기 시간은 3시간 18분이고 금리 차는 2.5%p이며 비율은 1/3이다.', '경기 시간은 세-시간 십팔분이고 금리 차는 이-쩜-오-퍼센트포인트이며 비율은 삼분의 일이다.'),
        ('향후 2주 동안 발표될 지표와 1/3 확률, -1/3 조정폭, 2.5%p 변동을 함께 본다.', '향후 이주 동안 발표될 지표와 삼분의 일 확률, 마이너스 삼분의 일 조정폭, 이-쩜-오-퍼센트포인트 변동을 함께 본다.'),
    ],
)
