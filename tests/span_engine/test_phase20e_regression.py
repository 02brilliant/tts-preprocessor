...
from engine.span_engine.production_adapter import transform_for_production, run_rollout_transform
...
def test_phase20e_regression_rollout_span_default_remains_stable() -> None:
    result = run_rollout_transform("90km/h", mode="span_default")
