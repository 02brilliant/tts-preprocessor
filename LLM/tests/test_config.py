...
def test_prompt_paths_are_distinct_runtime_assets() -> None:
    ...
    assert STAGE4_PRONUNCIATION_PATH.name == "stage4_pronunciations.json"
    assert STAGE4_PRONUNCIATION_PATH.is_file()
    assert len({LLM_PROMPT_PATH, LLM_PROMPT_LV3_PATH}) == 2
