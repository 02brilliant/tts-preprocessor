...
# Production transform requests call packaged binaries for levels 1-4.
...
def main() -> None:
    ...
    standard_llm_binary_path = resolve_integrated_binary_path(3)
    natural_llm_binary_path = resolve_integrated_binary_path(4)
    print(f"Using runtime binary: {binary_path}")
    print(f"Using simplified runtime binary: {simplified_binary_path}")
    print(f"Using level-3 integrated binary: {standard_llm_binary_path}")
    print(f"Using level-4 integrated binary: {natural_llm_binary_path}")
